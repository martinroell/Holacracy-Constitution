...
Alternatively, a Core Circle Member may distribute a Proposal to all other Core Circle Members asynchronously, outside of a Governance Meeting, using any written communication channel approved for this purpose by the Circle’s Secretary. When this happens, the Facilitator may either apply the same process and rules used within a Governance Meeting, or may allow all Core Circle Members to directly declare whether or not they have Objections to integrate. Further, at any point before an asynchronous Proposal is adopted, the Facilitator or any Core Circle Member may stop the asynchronous processing by requesting the Proposer escalate the Proposal to a Governance Meeting, and notifying the Circle’s Secretary.
...
- **(b) Fill Out Ballots:** All participants must then fill out a ballot to nominate whomever the participant believes is the best fit for the Role among all eligible candidates. All participants must label their ballots with their own name as well, and no one may abstain or nominate multiple people. Before and during this step, the Facilitator must promptly stop all comments or discussion about potential candidates or nominations.
...
- **(d) Nomination Change Round:** Once all nominations are shared, the Facilitator must give all participants the opportunity to change their nominations. Participant making a change may explain their changes, but the Facilitator must stop any other comments or discussion.
